...
use Money\Money;
use Money\Currency;
use BrianFaust\Basket\TaxRates\UnitedKingdomValueAddedTax;
...
``` php
BrianFaust\Basket\Discounts\ValueDiscount;
BrianFaust\Basket\Discounts\PercentageDiscount;
...
``` php
use BrianFaust\Basket\Categories\PhysicalBook;
...
use BrianFaust\Basket\Jurisdictions\UnitedKingdom;
...
``` php
$basket->rate();     // BrianFaust\Basket\TaxRate
...
use BrianFaust\Basket\Fixtures\BasketFixture;
